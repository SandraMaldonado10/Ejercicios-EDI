...
public:
   ...
   // GETTERS:
	 ...
	 * POST: devuelve el año en el que está programada la consulta
	 * COMPLEJIDAD: O(1)
	 */
	int getAnio() const;
	/**
	 * PRE: que la instancia haya sido creada correctamente
	 * POST: devuelve el dia en el que está programada la consulta
	 * COMPLEJIDAD: O(1)
	 */
	int getDia() const;
	/**
	 * PRE: que la instancia haya sido creada correctamente
	 * POST: devuelve la hora en la que está programada la consulta
	 * COMPLEJIDAD: O(1)
	 */
	int getHora() const;
	/**
	 * PRE: que la instancia haya sido creada correctamente
	 * POST: devuelve el mes en el que está programada la consulta
	 * COMPLEJIDAD: O(1)
	 */
	int getMes() const;
	/**
	 * PRE: que la instancia haya sido creada correctamente
	 * POST: devuelve los minutos en los que está programada la consulta
	 * COMPLEJIDAD: O(1)
	 */
